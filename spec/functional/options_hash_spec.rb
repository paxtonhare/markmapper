...
describe MarkMapper::OptionsHash do
  ...
  describe "#[]=" do
    ...
    #   subject[:sort].should == [MarkMapper::SortOperator.new(:foo, MarkMapper::SortOperator::ASC)]
    ...
    #   subject[:sort] = "id asc"
    #   subject[:sort].should == [MarkMapper::SortOperator.new(:_id, MarkMapper::SortOperator::ASC)]
    # end
