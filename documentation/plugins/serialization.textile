...
Note that "embedded documents":{{ site.baseurl }}/documentation/documents/embedded-document.html are included in the serialized output without any intervention.
